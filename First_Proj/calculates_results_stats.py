...
# DATE CREATED: June 19th, 2024                  
# REVISED DATE: June 24th, 2024
...
def calculates_results_stats(results_dic):
        ...
        for key in results_dic:
                ...
                # print("results_dic[key][2] is: {}".format(results_dic[key][2]))
                # print("results_dic[key] is: {}\n".format(results_dic[key]))
        ...
        # print("\nMy no of corr dogs: {}".format(results_stats_dic['n_correct_dogs']))
        # print("My no of pet images : {}".format(results_stats_dic['n_images']))
        # print("count of dog images: {}\n".format(count))
