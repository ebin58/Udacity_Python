...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
          ...
          if line not in dognames_dic:
            dognames_dic[line] = 1
            # print("dog_names[line] is: {}".format(dognames_dic[line]))
            
          line = infile.readline()
        
        # print("Length of dict is: {}".format(len(dognames_dic)))
        # print(dognames_dic)
    ...
    for key in results_dic:
      ...
      # print("result at key b4 IF(108) is: {}".format(results_dic[key][0]))
      # print(results_dic[key][0].strip() in dognames_dic)
      if results_dic[key][0].strip() in dognames_dic:
        
        # Classifier Label IS image of Dog (e.g. found in dognames_dic)
        # appends (1, 1) because both labels are dogs
        # print("result at key b4 IF(114) is: {}".format(results_dic[key][1]))
        if results_dic[key][1] in dognames_dic:
          results_dic[key].extend((1, 1))
          # print("result at {} after extension is: {}\n".format(key, results_dic[key]))
          
        # Classifier Label IS NOT image of dog (e.g. NOT in dognames_dic)
        # appends (1,0) because only pet label is a dog
        else:
          results_dic[key].extend((1,0))
          # print("result at {} after extension(122) is: {}\n".format(key, results_dic[key]))
